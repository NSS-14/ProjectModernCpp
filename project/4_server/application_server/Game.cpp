...
//
//				m_map[inputCoordinate] = std::make_shared<Player>(m_players[playerToChoose]);
//				m_players[playerToChoose].InsertRegion({ inputCoordinate, Player::kScoreDefaultValue });
//				freeSpaces--;
//			}
//			Update();
//		}
...
//			std::vector<Player::Coordinates> neighbours = m_map.Neighbours(randomPlayerOrder[j] + 1);
